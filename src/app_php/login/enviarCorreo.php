...
function enviar($para, $codigo){
  ...
  <style type="text/css" align="center" class="float-center">.header{background:#8a8a8a;}.header .columns{padding-bottom:0;}.header p{color:#fff;padding-top:15px;}.header .wrapper-inner{padding:20px;}.header .container{background:transparent;}table.button.facebook table td{background:#3B5998!important;border-color:#3B5998;}table.button.twitter table td{background:#1daced!important;border-color:#1daced;}table.button.google table td{background:#DB4A39!important;border-color:#DB4A39;}.wrapper.secondary{background:#f3f3f3;}</style>
  <body>
  ...
  <th>
  <h1>¡Hola!</h1>
  <p class="lead">Has realizado la solicitud para un cambio de contraseña para el usuario '.$correo.'</p>
  <p>Para proceder al cambio de contraseña deberás ingresar a la aplicación de <b>Actívate CODE</b> e
    introducir el siguiente código de acceso.</p>
  <table class="callout">
  <tr>
  <th class="callout-inner primary">
  <p style="font-size:40px; text-align:center;"><b>'.$codigo.'</b> </p>
  </th>
  ...
  <tr>
  <td>
  <center data-parsed=""><a href="https://www.facebook.com/GuanajuatoCODE/" align="center" class="float-center">Facebook</a></center>
  </td>
  </tr>
  </table>
  </td>
  ...
  <tr>
  <td>
  <center data-parsed=""><a href="https://twitter.com/guanajuatocode?lang=es" align="center" class="float-center">Twitter</a></center>
  </td>
  </tr>
  </table>
  </td>
  ...
  <tr>
  <td>
  <center data-parsed=""><a href="http://www.codegto.gob.mx/" align="center" class="float-center">Sitio web</a></center>
  </td>
  </tr>
  </table>
  </td>
  ...
  <tr>
  <th>
  <h5>Estamos para servirte en:</h5>
  <p>MACROCENTRO 1 </p>
  <p>Carr. Gto-Dolores Hgo. Km. 1.5 Valenciana Guanajuato, Gto. </p>
  <p>473 732 40 96 | sistemas.code@guanajuato.gob.mx</p>
  </th>
  </tr>
  </table>
  </th>
